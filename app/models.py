...
class post(models.Model):
    ...
    content=RichTextUploadingField(null=True, blank=True, extra_plugins=['videodetector'], external_plugin_resources=[('videodetector', 'staticfiles/ckeditor/videodetector-master', 'plugin.js')])
